...
volatile dataType q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f;	// quaternion of sensor frame relative to auxiliary frame

//---------------------------------------------------------------------------------------------------
// Function declarations

dataType invSqrt(dataType x);
...
void MadgwickAHRSupdate(dataType* quaternion, dataType gx, dataType gy, dataType gz, dataType ax, dataType ay, dataType az, dataType mx, dataType my, dataType mz, dataType dt, dataType beta) {
	...
	dataType qDot1, qDot2, qDot3, qDot4;
	dataType hx, hy;
	dataType _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx, _4bz, _2q0, _2q1, _2q2, _2q3, _2q0q2, _2q2q3, q0q0, q0q1, q0q2, q0q3, q1q1, q1q2, q1q3, q2q2, q2q3, q3q3;
	...
	if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
		...
		_4bx = 2.0f * _2bx;
		_4bz = 2.0f * _2bz;
		dataType _8bx = 2.0f * _4bx;
		dataType _8bz = 2.0f * _4bz;
...
void MadgwickAHRSupdateIMU(dataType* quaternion, dataType gx, dataType gy, dataType gz, dataType ax, dataType ay, dataType az, dataType dt, dataType beta) {
	...
	dataType s0, s1, s2, s3;
	dataType qDot1, qDot2, qDot3, qDot4;
	dataType _2q0, _2q1, _2q2, _2q3, _4q0, _4q1, _4q2 ,_8q1, _8q2, q0q0, q1q1, q2q2, q3q3;
...
// 		dataType tmp = *(dataType*)&i;
// 		return tmp * (1.69000231f - 0.714158168f * x * tmp * tmp);
// 	}
// 	else
// 	{
// 		/* optimal but expensive method: */
// 		return 1.0f / (dataType)sqrt(x);
// 	}
// }

// Maybe for floats only
